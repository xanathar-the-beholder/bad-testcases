...
public class AutomateTests {
	...
	public void shouldRefenceClasses() {
		someHelperMethd(1, 21, 3, 4, 5, 6, 7, 8, 9, 10, 11);
	...
	/**
	 * Note that some classes required more than one invocation for it to be removed
	 * from the list.
	 */
	@Test
	...
	public int someHelperMethd(int a, int b, int c, int d, int e, int f, int g, int h, int i, int j, int k) {
		return a + b + c + d + e + f;
	}
